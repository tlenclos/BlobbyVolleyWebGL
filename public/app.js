...
var _Box2dWeb21A = require('./libs/Box2dWeb-2.1.a.3');

var _Box2dWeb21A2 = _interopRequireDefault(_Box2dWeb21A);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var b2Vec2 = _Box2dWeb21A2.default.Common.Math.b2Vec2,
    b2FixtureDef = _Box2dWeb21A2.default.Dynamics.b2FixtureDef,
    b2BodyDef = _Box2dWeb21A2.default.Dynamics.b2BodyDef,
    b2Body = _Box2dWeb21A2.default.Dynamics.b2Body,
    b2CircleShape = _Box2dWeb21A2.default.Collision.Shapes.b2CircleShape;
...
var Ball = function () {
    ...
    Ball.prototype.physics = function physics() {
        ...
        if (speed > this.maxSpeed) {
            body.SetLinearVelocity(new b2Vec2(this.maxSpeed / speed * velocity.x, this.maxSpeed / speed * velocity.y));
        }
...
var Blob = function () {
    ...
    Blob.prototype.move = function move(x, y) {
        ...
        if (x !== 0) {
            ...
            body.ApplyForce(new b2Vec2(force, 0), body.GetDefinition().position);
        }
    };
    ...
    Blob.prototype.handleJump = function handleJump() {
        ...
        // Jumping
        if (this.jumpAllowed) {
            body.ApplyImpulse(new b2Vec2(0, 9 * this.fixture.GetBody().GetMass()), body.GetDefinition().position);
...
var b2FixtureDef = _Box2dWeb21A2.default.Dynamics.b2FixtureDef,
    b2BodyDef = _Box2dWeb21A2.default.Dynamics.b2BodyDef,
    b2Body = _Box2dWeb21A2.default.Dynamics.b2Body,
    b2PolygonShape = _Box2dWeb21A2.default.Collision.Shapes.b2PolygonShape;
...
var Field = function () {
    ...
    Field.prototype.init = function init() {
        ...
        rightWall = this.createWall(this.x + this.width / 2 + 0.5, this.y + this.height / 2, 0.5, this.height * 2, 20, null, 0, null, null, 0xDEDEDE, 0);
    ...
    Field.prototype.createWall = function createWall(x, y, width, height, depth, density, friction, restitution, texture, color, opacity, userData) {
        var bodyDef = new b2BodyDef();
        ...
        var fixDef = new b2FixtureDef();
        fixDef.density = _lodash2.default.isNumber(density) ? density : 1;
        fixDef.friction = _lodash2.default.isNumber(friction) ? friction : 0.5;
        fixDef.restitution = _lodash2.default.isNumber(restitution) ? restitution : 0;
...
require.register("libs/Box2dWeb-2.1.a.3.js", function(exports, require, module) {
...
var Party = function () {
    ...
    Party.prototype.update = function update() {
...
var b2Vec2 = _Box2dWeb21A2.default.Common.Math.b2Vec2,
    b2World = _Box2dWeb21A2.default.Dynamics.b2World;
...
var Physics = function () {
    ...
    Physics.prototype.init = function init() {
        this.world = new b2World(new b2Vec2(0, -this.gravity), true);
    };
    ...
    Physics.prototype.step = function step() {
        this.world.Step(window.dt, 10, 10);
